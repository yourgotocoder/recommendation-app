...
const GetSpecialty = (props: Props) => {
  ...
  if (submitted) {
    return (
      <Card sx={{minWidth: 400, padding: 2}}>
        Thank you for submitting your fields of interest. A mentor will be
        assigned to you soon who specializes in your fields of interest.
      </Card>
    );
  }
    ...
    >
                ...
                >
                  {selected.map((value) => (
                    <Chip
                      key={value}
                      label={value}
                      color={fieldName.length !== 3 ? "primary" : "default"}
                    />
                  ))}
                </Box>
              )}
      ...
      <CardActions sx={{ display: "flex", justifyContent: "center" }}>
        <Button
          ...
          disabled={fieldName.length !== 3 || submitting === true}
        >
